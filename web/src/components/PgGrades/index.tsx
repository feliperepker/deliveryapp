...
const arrayTeste = ["Grade", "Low-Grill"]
...
export function PgGrades(){
  ...
  function mudarItens(){
    //Função que requisita a alteração de algum item no ID 2
    if (pedido.status == true){
      axios.put("http://localhost:5264/Edicao/2", 
    {
      id: 2,
      area: pedido.area,
      pedido: items,
      ...
      axios.put("http://localhost:5264/Pedidos/2", 
      {
        id: 2,
        area: pedido.area,
        pedido: items,
