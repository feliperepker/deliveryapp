...
const arrayTeste = ["Tanque", "Válvula"]


export function PgTanque(){
  ...
  function mudarItens(){
    //Função que requisita a alteração de algum item no ID 4
    if (pedido.status == true){
      axios.put("http://localhost:5264/Edicao/4", 
    {
      id: 4,
      area: pedido.area,
      pedido: items,
      ...
      axios.put("http://localhost:5264/Pedidos/4", 
      {
        id: 4,
        area: pedido.area,
        pedido: items,
