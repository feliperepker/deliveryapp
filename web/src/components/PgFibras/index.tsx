...
export function PgFibras(){
  ...
  function mudarItens(){
    //Função que requisita a alteração de algum item no ID 1
    if (pedido.status == true){
      axios.put("http://localhost:5264/Edicao/1", 
    {
      id: 1,
      area: pedido.area,
      pedido: items,
      ...
      axios.put("http://localhost:5264/Pedidos/1", 
      {
        id: 1,
        area: pedido.area,
        pedido: items,
